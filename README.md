<!-- EdGraph context: This is a reference/vendored copy of the Azure Verified Modules (AVM) storage account module. It is used as a reference for storage account configuration in EG.Terraform.Azure and EG.Terraform.Clients. Do not modify this module directly — upgrade the version reference in the consuming workspace instead. -->

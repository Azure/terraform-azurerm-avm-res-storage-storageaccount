...
resource "azurerm_monitor_diagnostic_setting" "blob" {
  ...
  name                           = each.value.name != null ? each.value.name : "diag-${var.name}-blob"
...
resource "azurerm_monitor_diagnostic_setting" "queue" {
  ...
  name                           = each.value.name != null ? each.value.name : "diag-${var.name}-queue"
...
resource "azurerm_monitor_diagnostic_setting" "table" {
  ...
  name                           = each.value.name != null ? each.value.name : "diag-${var.name}-table"
...
resource "azurerm_monitor_diagnostic_setting" "azure_file" {
  ...
  name                           = each.value.name != null ? each.value.name : "diag-${var.name}-file"

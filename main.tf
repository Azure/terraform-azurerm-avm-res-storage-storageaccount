  ...
  dynamic "blob_properties" {
    ...
    content {
      ...
      dynamic "delete_retention_policy" {
        for_each = (
        blob_properties.value.delete_retention_policy != null && try(blob_properties.value.delete_retention_policy.enabled, true)) ? [blob_properties.value.delete_retention_policy] : []
